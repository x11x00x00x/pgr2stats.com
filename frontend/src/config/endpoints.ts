...
export const endpoints: Endpoint[] = [
  { id: 'latestchanges', name: 'Latest Changes', url: 'https://api.pgr2stats.com/api/latestchanges' },
  { id: 'matches', name: 'Matches', url: 'https://api.pgr2stats.com/api/matches' },
  { id: 'livecities', name: 'Live Cities', url: 'https://api.pgr2stats.com/api/livecities' },
  { id: 'timeattacktop3', name: 'Time Attack Top 3', url: 'https://api.pgr2stats.com/api/timeattacktop3' },
  { id: 'timeattacktop10', name: 'Time Attack Top 10', url: 'https://api.pgr2stats.com/api/timeattacktop10' },
  { id: 'top3', name: 'Top 3', url: 'https://api.pgr2stats.com/api/top3' },
  { id: 'top10', name: 'Top 10', url: 'https://api.pgr2stats.com/api/top10' },
  { id: 'arcade', name: 'Arcade', url: 'https://api.pgr2stats.com/api/arcade' },
  ...Object.entries(leaderboardNames).map(([key, name]) => ({
    id: `leaderboard_${key.replace('#', '')}`,
    name,
    url: `https://api.pgr2stats.com/api/leaderboard_${key.replace('#', '')}`
  }))
]; 